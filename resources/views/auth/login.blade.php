...
<head>
    ...
    <style>
        ...
        .form .input.is-invalid {
            border-inline: 2px solid #dc3545;
        }
...
<body>
    <div class="container">
        ...
        <!-- Session Status -->
        @if (session('status'))
            <div style="background: #d1ecf1; border: 1px solid #bee5eb; color: #0c5460; padding: 10px; border-radius: 15px; margin-top: 15px; font-size: 12px; text-align: center;">
                {{ session('status') }}
            </div>
        @endif
